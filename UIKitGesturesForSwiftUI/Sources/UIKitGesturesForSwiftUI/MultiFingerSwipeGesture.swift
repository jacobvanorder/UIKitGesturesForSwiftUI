...
public struct MultiFingerSwipeGesture: UIGestureRecognizerRepresentable {
    ...
    /// The delegate object for the underlying `UISwipeGestureRecognizer`.
    ///
    /// This coordinator implements `UIGestureRecognizerDelegate` to control whether
    /// the swipe gesture can be recognized simultaneously with other gestures.
    ...
    public class Coordinator: NSObject, UIGestureRecognizerDelegate {
        ...
        ///
        /// - Parameters:
        ///   - gestureRecognizer: The swipe gesture recognizer owned by this struct.
